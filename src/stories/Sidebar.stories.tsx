 ...
 * ### 접힘 상태의 이름은 툴팁입니다
 *
 * 라벨이 화면에서 사라지므로 **툴팁이 유일한 이름**입니다.
 * Figma 문서에 "Tooltip 이 필요합니다 (미구현)" 이라고 적혀 있던 자리를 채웠습니다.
 *
 * ### 접으면 로고가 토글입니다
 *
...
/**
 * **헤더의 메뉴 아이콘으로 접었다 펴 보세요.** 접히면 2단계가 사라지고
 * 1단계 아이콘만 남습니다 — 아이콘에 마우스를 올리면 툴팁이 이름을 알려 줍니다.
 */
